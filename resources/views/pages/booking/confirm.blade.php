@extends('layouts.app', ['title' => 'Confirm Payment'])
        ...
        <form action="{{ route('bookings.store') }}" method="POST"
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    ...
                    <input type="file" name="payment_proof" id="Proof" class="absolute -z-10" required>
                </div>
            </div>
...
@push('scripts')
    <script src="{{ asset('js/front/payment.js') }}"></script>
@endpush
